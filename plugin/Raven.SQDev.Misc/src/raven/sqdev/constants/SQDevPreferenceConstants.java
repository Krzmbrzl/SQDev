...
public class SQDevPreferenceConstants {
	...
	/**
	 * The preference indicating the whether or not the user should be informed
	 * about pars mode changes
	 */
	public static final String SQDEV_EDITOR_PARSE_MODE_CHANGE_NOTIFICATION = "raven.sqdev.parsingModeChangeNotification";
