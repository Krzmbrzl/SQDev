...
public class BasicSourceViewerConfiguration extends SourceViewerConfiguration implements IPropertyChangeListener {
	 ...
	 */
	public List<Keyword> getAllConfiguredKeywordsAsList() {
		ArrayList<Keyword> keywordList = new ArrayList<Keyword>();

		Iterator<Entry<String, KeywordScanner>> iterator = configuredKeywordScanners.entrySet().iterator();
	 ...
	 * Gets all configured Keywords
	 */
	public Map<String, Keyword> getAllConfiguredKeywords() {
	 ...
	 * @return The <code>KeywordScanner</code> working for the given preference key
	 *         or <code>null</code> if no such scanner could be found
	 */
	...
	/**
	 * Creates a <code>KeywordScanner</code> for the given preference key that is
	 * automatically registered to this <code>BasicSourceViewerConfiguration</code>
	 ...
	 * @return The matching <code>KeywordScanner</code> or <code>null</code> if none
	 *         could be found
	 */
