...
public class syntaxArchiveList {
	...
	/**
	 * This functions generates a grammar out of the stored syntaxes and writes it into the given
	 * file
	 * 
	 * @param outputDirectory
	 *            Where the grammar should be stored
	 * @param modelDirectory
	 *            The directory for any rule-models that should be injected into the grammar
	 */
	public void write(String outputDirectory, String modelDirectory) {
		...
		try {
			...
			for (syntaxArchive currentArchive : this.list) {
				...
				for (syntaxVariant currentVariant : currentArchive.getArchive().getArchive()) {
